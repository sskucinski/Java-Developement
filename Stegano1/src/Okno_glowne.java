...
public class Okno_glowne extends JFrame {
    ...
    private void jButtonZapiszActionPerformed(ActionEvent evt) {
    	if(stat_sciezka == "" || stat_nazwa == ""){
    		...
    		if(SteganoBMP.encode(stat_sciezka,stat_nazwa,rozszerzenie,nazwaNowego,text))
    		{
    ...
    private void jButtonOdczytajActionPerformed(ActionEvent evt) {
    	...
    	String message = SteganoBMP.decode(stat_sciezka, stat_nazwa);
		System.out.println(stat_sciezka + ", " + stat_nazwa);
		if(message != "")
		{
